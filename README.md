...
2. [Install Norwegian Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Norwegian language pack](#3-how-to-active-hungarian-language-pack)
