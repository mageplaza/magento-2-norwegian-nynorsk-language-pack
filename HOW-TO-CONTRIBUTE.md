# How to contribute Norwegian Language pack
...
- [github_contributions.csv](https://github.com/mageplaza/magento-2-norwegian-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza and Magento community.

- We will merge `github_contributions.csv` with [no_NO.csv](https://github.com/mageplaza/magento-2-norwegian-language-pack/blob/master/no_NO.csv). Your Magento 2 store will use this csv file.

So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-norwegian-language-pack/blob/master/github_contributions.csv) file.
...
#### Suggestions
- You can copy any part of `no_NO.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `no_NO.csv`, we will not approve it in this case.
