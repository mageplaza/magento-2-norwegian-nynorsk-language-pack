...
- We will merge `github_contributions.csv` with [nb_NO.csv](https://github.com/mageplaza/magento-2-norwegian-language-pack/blob/master/nb_NO.csv). Your Magento 2 store will use this csv file.
...
#### Suggestions
- You can copy any part of `nb_NO.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `nb_NO.csv`, we will not approve it in this case.
